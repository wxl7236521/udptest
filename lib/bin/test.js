...
const udpTest_1 = __importDefault(require("./udpTest"));
commander_1.program
...
if (commander_1.program.server && commander_1.program.port && commander_1.program.socketType) {
    new udpTest_1.default(null, null, null, null, null, commander_1.program.port, false, null, commander_1.program.socketType);
...
if (commander_1.program.client && commander_1.program.port && commander_1.program.numPacket && commander_1.program.sendCount && commander_1.program.perCount && commander_1.program.interval
    ...
    new udpTest_1.default(commander_1.program.numPacket, commander_1.program.sendCount, commander_1.program.perCount, commander_1.program.interval, commander_1.program.ip, commander_1.program.port, true, null, commander_1.program.socketType).sendData(commander_1.program.id);
}
